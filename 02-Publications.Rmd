...
| **Investigation** | Performed benchmark tests (Figure 1 and Supplementary File S2) to demonstrate MIRPIPEs capabilities to reproduce findings and proving its predictive efficiency |
| **Software** | Implementation of the graph-based isoMiR handling |
| **Resources ** | Setup and administration of MIRPIPEs web service |
...
| |   |
|-|---|
| **Conceptualization** | Definition of ADMIRE capabilities for analysis and visualization |
| **Methodology** | Formulation of the software layout, its inputs and outputs; Formulation of ADMIREs differential testing procedure |
| **Investigation** | Conducted analysis of the RA and AF datasets; Interpretation and discussion of results |
| **Validation** | Benchmarking ADMIRE against RnBeads; Evaluation of ADMIREs performance |
| **Software** | Implementation / Programming of ADMIRE |
| **Visualization** | Creation of Fig. 1 to Fig. 4, Additional files 4 to 8 |
| **Resources ** | Setup and administration of ADMIREs web service |
| **Writing** | Preparation of the software manual (Additional File 3); Review and editing of the manuscript |

...
Carsten Kuenne^1,$\ddagger$^, Jens Preussner^1,$\ddagger$^, Mario Herzog^1^, Thomas Braun^2^ and Mario Looso^1^
...
**Supplementary data**               available [online](https://academic.oup.com/bioinformatics/article/30/23/3412/207691#supplementary-data)
------------------    ---------------------------------------------------------------------------------------------------------------------
...
**Supplementary data**               available [online](https://epigeneticsandchromatin.biomedcentral.com/articles/10.1186/s13072-015-0045-1#Sec14)
------------------    ---------------------------------------------------------------------------------------------------------------------
...
Jens Preussner^1,2,$\ddagger$^, Jiasheng Zhong^1,$\ddagger$^, Krishnamoorthy Sreenivasan^1^, Stefan Günther^1,3^, Thomas Engleitner^4^, Carsten Künne^1,2^, Markus Glatzel^5^, Roland Rad^4^, Mario Looso^2^, Thomas Braun^1,6,7^ and Johnny Kim^1,6^
...
**Supplementary data**               available [online](https://www.sciencedirect.com/science/article/pii/S1934590918304922#app2)
------------------    ---------------------------------------------------------------------------------------------------------------------
...
| **Validation** | Examined Dux-dependent zygotic gene activation in @chenTargetingOxidativeStress2013, @davicioniMolecularClassificationRhabdomyosarcoma2009 and @williamsonFusionGeneNegative2010 |
...
```{r, results='asis', echo=FALSE, eval=knitr::is_latex_output()}
cat("\\includepdf[pages={-}]{publications/2018_duxbl_supl.pdf}")
```
